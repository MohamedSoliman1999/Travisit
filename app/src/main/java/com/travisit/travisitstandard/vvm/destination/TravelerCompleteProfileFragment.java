...
public class TravelerCompleteProfileFragment extends Fragment {
    ...
    private String getFieldText(String fieldName){
        switch (fieldName){
            case "full name": return binding.fTravelerCompleteProfileTietFullName.getText().toString();
            case "email": return binding.fTravelerCompleteProfileTietEmailAddress.getText().toString();
            case "phone": return binding.fTravelerCompleteProfileTietPhone.getText().toString();
            case "nationality": return binding.fTravelerCompleteProfileTietNationality.getText().toString();
