...
public class OffersAdapter extends RecyclerView.Adapter<OffersAdapter.OfferViewHolder> implements Filterable {
    ...
    class OfferViewHolder extends RecyclerView.ViewHolder {
        ...
        public OfferViewHolder(@NonNull View itemView) {
            super(itemView);
            offerImage = itemView.findViewById(R.id.card_explore_sdv_image);
            offerName = itemView.findViewById(R.id.card_explore_tv_name);
        ...
        public void set(Offer item, Context context, SelectionPropagator observer) {
            ...
            rating.setText("3.5");
            date.setText(context.getString(R.string.ends_on) + " " + item.getEndDate());
